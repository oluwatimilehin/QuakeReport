...
public class EarthquakeActivity extends AppCompatActivity {
    ...
    private class  NetworkAsyncTask extends AsyncTask<String, Void, ArrayList<Earthquake>>
    {

        @Override
        protected ArrayList<Earthquake> doInBackground(String... params) {
            final ArrayList<Earthquake> earthquakes = QueryUtils.extractEarthquakes(params[0]);
            return earthquakes;
        }
        ...
        protected void onPostExecute( final  ArrayList<Earthquake> earthquakes) {
            ...
            earthquakeListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse(earthquakes.get(position).getUrl()));
                    startActivity(i);
